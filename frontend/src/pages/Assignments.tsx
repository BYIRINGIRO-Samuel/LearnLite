...
const Assignments = () => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      // Update assignments state by filtering out the deleted item
      setAssignments(assignments.filter(assignment => assignment.id !== itemToDelete.id));
      toast.success(`Assignment "${itemToDelete.title}" has been deleted`);
      setShowDeleteModal(false);
      setItemToDelete(null);
    } catch (error) {
      toast.error(`Failed to delete assignment "${itemToDelete.title}"`);
    }
  };
  ...
  return (
    <div className="flex h-screen w-full">
      ...
      <div className="flex flex-col flex-1 overflow-x-hidden overflow-y-auto hide-scrollbar p-6 bg-gray-100">
          ...
          <div className="hidden md:block relative w-full mt-4 mb-11 ml-6 mr-6">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
              <h1 className="text-3xl font-bold mb-2 text-white mr-20">
                Welcome <span className="text-black font-bold">Ngwije</span>
              </h1>
              <p className="text-xl text-white font-semibold mr-20">
                All your assignments in one place — check instructions, submit
                your work, and keep learning at your pace.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M5.121 17.804A13.939 13.939 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 3a9 9 0 11-18 0 9 9 0 0118 0z"
                    />
                  </svg>
