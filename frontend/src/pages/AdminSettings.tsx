    ...
    <div className="flex h-screen w-full bg-gray-50">
      ...
      <div className="flex flex-1">
        <div className="w-1/3 border-r border-gray-200 bg-white">
          ...
          <div
            className={`flex gap-4 ml-5 mt-5 items-center cursor-pointer p-2 ${selectedSection === "Account Settings" ? "bg-gray-200" : ""}`}
          ...
          <div
            className={`flex gap-4 ml-5 mt-5 items-center cursor-pointer p-2 ${selectedSection === "Notifications" ? "bg-gray-200" : ""}`}
          ...
          <div
            className={`flex gap-4 ml-5 mt-5 items-center cursor-pointer p-2 ${selectedSection === "Appearances" ? "bg-gray-200" : ""}`}
