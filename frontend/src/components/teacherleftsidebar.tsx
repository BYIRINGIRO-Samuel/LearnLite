...
const Leftsidebar = () => {
  ...
  return (
    <nav className="hidden md:flex flex-col min-h-screen w-72 bg-white border-r border-gray-200 shadow-sm">
      <div className="flex-1 flex flex-col gap-6 px-6 py-3">
        <Link to="/teacherdashboard" className="flex items-center gap-2 mb-8">
          <svg
